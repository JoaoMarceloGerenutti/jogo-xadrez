...
public class ChessMatch {
	...
	private void setupInicial() {
		...
		colocarNovaPeca('H', 7, new Tower(tabuleiro, Color.BRANCO));
		colocarNovaPeca('D', 1, new Tower(tabuleiro, Color.BRANCO));
		colocarNovaPeca('E', 1, new King(tabuleiro, Color.BRANCO));
		
		colocarNovaPeca('B', 8, new Tower(tabuleiro, Color.PRETO));
		colocarNovaPeca('A', 8, new King(tabuleiro, Color.PRETO));
		/*
		//PEÇAS PRETAS ATRAS
